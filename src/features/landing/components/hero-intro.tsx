  ...
  return (
    <m.div variants={container} initial="hidden" animate="visible">
      ...
      >
        ...
        {/* « Engagement vert » cue in the hero fold (client feedback,
            2026-07-17): the green selling point must be visible on mobile
            without scrolling. A compact chip here echoes the full
            « Éco-responsable » band directly below the hero. */}
        <span className="border-success/35 bg-success/12 text-mist inline-flex items-center gap-2 self-center rounded-full border px-3.5 py-1.5 text-center text-xs font-semibold backdrop-blur-sm">
          <svg
            aria-hidden
            viewBox="0 0 24 24"
            fill="none"
            ...
            className="text-success size-3.5 flex-none"
          >
            <path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z" />
            <path d="M2 21c0-3 1.85-5.36 5.08-6" />
          </svg>
          0 km parcouru · 100 % en ligne
        </span>
        <a
